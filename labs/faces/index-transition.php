...
<body>
	...
	<script src="Leaflet.Instagram.Cluster2.js"></script>	
	<script>
	...
	L.instagram.cluster('http://photogrammar2.cartodb.com/api/v2/sql?q=SELECT *  FROM faces2').addTo(map); 



/*
L.Instagram.markers.on('clusterclick', function (a) {
